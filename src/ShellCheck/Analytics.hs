...
prop_checkConstantIfs10 = verify checkConstantIfs "[ abc = abc ] ; echo $?"
prop_checkConstantIfs11 = verify checkConstantIfs "[ abc == abc ] ; echo $?"
prop_checkConstantIfs12 = verify checkConstantIfs "test abc = abc ; echo $?"
prop_checkConstantIfs13 = verify checkConstantIfs "test abc == abc ; echo $?"
